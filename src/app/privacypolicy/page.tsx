// import styles from "./pvpcstyles.module.css";
// import "./pvpc.css";
  ...
  return (
    <div className="w-[90%] max-w-[1024px] mx-auto my-10">
      ...
      <ul>
        ...
        <li style={styles.li}>
          <p style={styles.p}>
            ...
            this Agreement) refers to ChitChatChit.
          </p>
        </li>
        <li style={styles.li}>
          <p style={styles.p}>
        ...
        <li style={styles.li}>
          <p style={styles.p}>
            <strong>Website</strong> refers to ChitChatChit, accessible from{" "}
            <a style={styles.a}
              href="https://chit-chat-chit.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://chit-chat-chit.vercel.app/
            </a>
          </p>
        </li>
        <li style={styles.li}>
      ...
      <ul>
        ...
        <li style={styles.li}>
          <p style={styles.p}>First name and last name</p>
        </li>
        <li style={styles.li}>
          <p style={styles.p}>Usage Data</p>
        </li>
      </ul>
      ...
      <ul>
        <li style={styles.li}>
          ...
          <p style={styles.p}>Type: Session Cookies</p>
          <p style={styles.p}>Administered by: Us</p>
          <p style={styles.p}>
        ...
        <li style={styles.li}>
          ...
          <p style={styles.p}>Type: Persistent Cookies</p>
          <p style={styles.p}>Administered by: Us</p>
          <p style={styles.p}>
      ...
      <ul>
        <li style={styles.li}>By email: ashwinanand.dev@gmail.com</li>
      </ul>
    </div>
  );
};

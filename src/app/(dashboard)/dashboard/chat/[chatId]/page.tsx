...
const page: FC<PageProps> = async ({ params }: PageProps) => {
  ...
  // await new Promise((resolve) => setTimeout(resolve, 500000)); //loading state test
  ...
  return <div className='flex-1 justify-between flex flex-col h-full max-h-[calc(100vh-6rem)]'>
    ...
    <Messages chatId={chatId} chatPartner={chatPartner} sessionImg={session.user.image} initialMessages={messagesForGivenChatId} sessionId={session.user.id}/>

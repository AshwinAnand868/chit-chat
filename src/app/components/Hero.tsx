...
const Hero = () => {
  return (
    <section className="mt-8 md:mt-0 bg-red-400 h-[87.5vh]">
      <div className="container mx-auto flex flex-col md:flex-row items-center h-[85vh]">
        <div className="flex-1 text-center md:text-left text-white">
          ...
          <p className="text-[16px] md:text-lg text-white mb-10">
          ...
          <Link
            href="/login"
            className="bg-black text-white py-3 px-6 rounded-full text-lg hover:bg-white hover:text-black transition-all inline-flex items-center"
          >
            Get Started Now!
            <svg
